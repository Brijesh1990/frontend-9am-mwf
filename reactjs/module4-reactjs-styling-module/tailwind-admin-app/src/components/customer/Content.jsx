  ...
  return (
      <>
        ...
        <section id='content' className='container mx-auto mt-16'>
         ...
         {/* products items */}
         <div className='products-app flex flex-row mt-10'>
        ...
        {/* contact us sections */}
        <div className='contact-us flex flex-row mt-16'>
        <div className='address p-16 w-1/2'>
        <h1 className='text-5xl'>Our Address</h1>
        ...
        <p className='mt-3'>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d59075.463026054276!2d70.68915472167966!3d22.269789600000006!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3959cb000e507455%3A0xf0cd3e17d20e1b1e!2sBlinkit%20store!5e0!3m2!1sen!2sin!4v1743395044069!5m2!1sen!2sin" width="100%" height="250" style={{border:0}} allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </p>
        </div>
        <div className='contact-form w-1/2 p-16'>
        <h1 className='text-5xl'>Contact Us Form</h1>
        <hr className='border-1 w-50'/> 
